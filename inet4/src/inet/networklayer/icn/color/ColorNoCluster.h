...
namespace inet{
    ...
    class INET_API colorNoCluster : public OperationalBase, public INetworkProtocol, public NetfilterBase, public IProtocolRegistrationListener, public cListener
    {
        public:
            struct SimRecorder
            {
                colorNoCluster *owner;
