...
//new
typedef intscale<B,1,1024> KB;
typedef scale<KB,1,1024> MB;
typedef scale<MB,1,1024> GB;
...
UNIT_DISPLAY_NAME(units::KB, "KB");
UNIT_DISPLAY_NAME(units::MB, "MB");
UNIT_DISPLAY_NAME(units::GB, "GB");
...
typedef value<int64_t, units::KB> KB;
typedef value<double, units::MB> MB;
typedef value<double, units::GB> GB;
